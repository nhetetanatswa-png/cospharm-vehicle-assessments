  ...
  return (
    <div className="app-shell">
      ...
      <section className="print-report" aria-hidden="true">
        <img className="print-watermark watermark-top" src="/assets/cospharm-logo.png" alt="" />
        <img className="print-watermark watermark-bottom" src="/assets/cospharm-logo.png" alt="" />
